        ...
        <div className="footer-container">
          <div className="footerContent">
            ...
            <div className="sicacikMenuler">
              ...
              <Link to="/:id">Terminal Pizza</Link>
              <Link to="/:id">5 Kişilik Hackathlon Pizza</Link>
              <Link to="/:id">UseEffect Tavuklu Pizza</Link>
              <Link to="/:id">Beyaz Console Frosty</Link>
              <Link to="/id">Testler Geçti Mutlu Burger</Link>
              <Link to="/:id">Position Absolute Acı Burger</Link>
            </div>
          </div>
